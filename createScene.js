class CreateScene extends Phaser.Scene {
    ...
    createName() {
        ...
        loginText.on("pointerdown", () => {
            ...
            //             saveToLocalStorage("recentLogin", true);
            //             saveToLocalStorage(CONSTANTS._charUserKey, activeUserName[0].name); // character user key
            //             saveToLocalStorage(CONSTANTS._charDetailsKey, activeUserName[0]); // character data
            //             this.validateLoggedIn();
