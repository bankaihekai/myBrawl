const CONSTANTS = {
    ...
    _petsAll: [
        { "name": "Bear", types: 'A', level: 1, life: 120, damage: 12, agile: 1, speed: 1, armor: 0, comboRate: 0, dodge: 5, accuracy: 60 },
        { "name": "Bear", types: 'B', level: 1, life: 120, damage: 12, agile: 1, speed: 1, armor: 0, comboRate: 0, dodge: 5, accuracy: 60 },
        { "name": "Bear", types: 'C', level: 1, life: 120, damage: 12, agile: 1, speed: 1, armor: 0, comboRate: 0, dodge: 5, accuracy: 60 },
    ...
    weaponStats: [
        ...
        { number: 1, name: "Heater Shield", damage: 12, combo: -150, speed: 200, counter: 30, accuracy: 60, evasion: -20, block: 45, disarm: 15, critical: 0 },
        { number: 2, name: "Trophy", damage: 11, combo: 7, speed: 100, counter: 10, accuracy: 90, evasion: 0, block: -10, disarm: 17, critical: 0 },
        { number: 3, name: "Cup of Coffee", damage: 3, combo: 250, speed: 0, counter: 3, accuracy: 90, evasion: 30, block: 15, disarm: 5, critical: 5 },
        { number: 4, name: "Gold Key", damage: 15, combo: 40, speed: 100, counter: 3, accuracy: 85, evasion: 0, block: -10, disarm: 50, critical: 5 },
        ...
        { number: 7, name: "Guitar", damage: 12, combo: 0, speed: 100, counter: 3, accuracy: 70, evasion: 0, block: -10, disarm: 15, critical: 5 },
        { number: 8, name: "Katana", damage: 30, combo: 80, speed: 100, counter: 15, accuracy: 90, evasion: 10, block: 10, disarm: 20, critical: 10 },
        { number: 9, name: "Wizard Staff", damage: 10, combo: 40, speed: 100, counter: 15, accuracy: 90, evasion: 10, block: 10, disarm: 10, critical: 10 },
        { number: 10, name: "Obsidian Blade", damage: 40, combo: -80, speed: 100, counter: 15, accuracy: 95, evasion: 10, block: 10, disarm: 20, critical: 10 },
        ...
        { number: 14, name: "Wooden Club", damage: 26, combo: -80, speed: 100, counter: 0, accuracy: 75, evasion: 0, block: -10, disarm: 15, critical: 5 },
        { number: 15, name: "Kanabo", damage: 36, combo: 60, speed: 100, counter: 0, accuracy: 80, evasion: 0, block: -10, disarm: 15, critical: 5 },
        { number: 16, name: "Saber", damage: 10, combo: 150, speed: 100, counter: 3, accuracy: 90, evasion: 30, block: 15, disarm: 8, critical: 5 },
        { number: 17, name: "Short Sword", damage: 14, combo: 110, speed: 0, counter: 15, accuracy: 85, evasion: 30, block: 15, disarm: 10, critical: 5 },
        { number: 18, name: "Scythe", damage: 22, combo: 80, speed: 100, counter: 15, accuracy: 85, evasion: 10, block: 10, disarm: 15, critical: 10 },
        { number: 19, name: "Hammer", damage: 55, combo: -100, speed: 150, counter: 0, accuracy: 45, evasion: -20, block: -20, disarm: 20, critical: 0 },
        { number: 20, name: "Rubber Duck", damage: 1, combo: 260, speed: 0, counter: 0, accuracy: 95, evasion: 30, block: 15, disarm: 5, critical: 0 },
        { number: 21, name: "Mace", damage: 20, combo: 0, speed: 0, counter: 10, accuracy: 80, evasion: 0, block: -10, disarm: 15, critical: 5 },
        { number: 22, name: "Behemoth Bone", damage: 16, combo: 100, speed: 0, counter: 3, accuracy: 90, evasion: 0, block: -10, disarm: 15, critical: 10 },
        ...
        { number: 26, name: "Long Sword", damage: 25, combo: 90, speed: 100, counter: 15, accuracy: 85, evasion: 10, block: 10, disarm: 15, critical: 10 },
        { number: 27, name: "Spadone Sword", damage: 28, combo: 60, speed: 100, counter: 15, accuracy: 85, evasion: 10, block: 10, disarm: 15, critical: 5 },
